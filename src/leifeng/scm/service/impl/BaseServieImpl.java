...
import leifeng.scm.dao.AccountRecordsMapper;
import leifeng.scm.dao.BaseMapper;
import leifeng.scm.dao.BuyOrderDetailMapper;
import leifeng.scm.dao.BuyOrderMapper;
import leifeng.scm.dao.GoodsMapper;
import leifeng.scm.dao.SupplierMapper;
import leifeng.scm.dao.SysParamMapper;
import leifeng.scm.entity.Page;
import leifeng.scm.service.BaseService;
...
public class BaseServieImpl<T> implements BaseService<T>{
	...
	@Override
	public int deleteByPrimaryKey(Integer supId) throws Exception {
		return baseMapper.deleteByPrimaryKey(supId);
	}
