	...
	$(function(){
			    ...
			    toolbar: [{
					...
					handler: function(){
						...
						parent.$('#win').window({ 
						    ...
						    height:600,    
						    modal:true,
						    content:"<iframe src='${proPath}/base/goURL/goods/selectGoods.action' height='100%' width='100%' frameborder='0px' ></iframe>"  
						});  
					}
				},'-',{
					iconCls: 'icon-remove',
			...
			onDblClickCell: function(index,field,value){
				...
				//结束编辑行, 可以不用，不会被调用，将在单击事件处理
					...
					/* var ed = $('#dg').datagrid('getEditor', {index:index,field:'birthday'});
